...
function ChallengeBox() {
  return (
    <>
      <div className='p-3 sm:p-6 rounded-lg bg-orange-600 text-white flex flex-col items-center justify-center gap-5'>
          <div className='flex items-center justify-center gap-2 sm:gap-5 w-full font-bold'>
            <h4 className='text-xl sm:text-2xl'> Ahmad_smoke </h4>
                <GiCrossedSwords className='text-3xl sm:text-6xl p-2 rounded-full bg-white text-orange-800'/>
