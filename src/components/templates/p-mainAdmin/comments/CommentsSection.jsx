          ...
          <table className="w-full text-xs md:text-sm overflow-x-auto">
            ...
            <tbody className="dark:bg-gray-700 dark:text-white p-2  ">
              <tr className="text-center">
                ...
                <td className="p-1"> علیرضا مرادی </td>
                <td className="p-1"> دراگون</td>
                <td className="p-1 text-ellipsis "> گلی که نمیرسی آب بدی، نکار </td>
                <td className="p-1 text-yellow-500"> در حال بررسی </td>
              ...
              <tr className="text-center">
                ...
                <td className="p-1 text-wrap"> هولمون دادن سقوط کنیم، هول شدیم پرواز کردیم </td>
                <td className="p-1 text-red-500"> رد شده است </td>
                <td className="p-1 flex items-center gap-2 justify-center">
                  <button className="text-base hover:scale-105 cursor-pointer text-red-500">
                    <FaTrash/>
                  </button>
