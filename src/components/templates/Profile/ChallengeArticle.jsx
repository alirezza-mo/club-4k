...
function ChallengeArticle() {
  return (
    <article className="relative border-2 border-orange-600 dark:border-gold bg-white dark:bg-black/90 rounded-lg p-10 mb-4 flex flex-col gap-4 transform transition duration-300 hover:scale-105 animate-fadeIn">
